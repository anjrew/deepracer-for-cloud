...
def get_graph_manager(hp_dict, agent_list, run_phase_subject, enable_domain_randomization=False,
    ...
    for agent in agent_list:
        if agent.network_settings:
            ...
            screen.log_title("Andrew Sanity test get_graph_manager.agent_params screenlog")
            screen.log_title(str(agent_params))
        else:
    ...
    screen.log_title("Andrew Sanity test get_graph_manager screenlog")
    screen.log_title(str(trainable_agents_list))
