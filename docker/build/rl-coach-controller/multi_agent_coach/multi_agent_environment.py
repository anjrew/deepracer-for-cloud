...
class MultiAgentEnvironment(EnvironmentInterface):
    ...
    def step(self, action: Union[List[ActionType], ActionType]) -> List[EnvResponse]:
        ...
        """
        screen.log_title("Andrew Sanity test MultiAgentEnvironment.step screenlog")

        print("Andrew Sanity test MultiAgentEnvironment.step print")
    ...
    def reset_internal_state(self, force_environment_reset=False) -> EnvResponse:
        ...
        """
        screen.log_title("Andrew Sanity test MultiAgentEnvironment.reset_internal_state screenlog")
    ...
    def get_random_action(self) -> Union[List[ActionType], ActionType]:
        ...
        """
        screen.log_title("Andrew Sanity test MultiAgentEnvironment.get_random_action screenlog")
    ...
    def get_goal(self) -> GoalType:
        ...
        :return: The goal
        """
        screen.log_title("Andrew Sanity test MultiAgentEnvironment.get_goal screenlog")
