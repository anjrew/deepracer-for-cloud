...
class MultiAgentLevelManager(EnvironmentInterface):
    ...
    def handle_episode_ended(self) -> None:
        ...
        :return: None
        """
        screen.log_title("Andrew Sanity test MultiAgentLevelManager.handle_episode_ended screenlog")
    ...
    def reset_internal_state(self, force_environment_reset: bool = False) -> EnvResponse:
        ...
        """
        screen.log_title("Andrew Sanity test MultiAgentLevelManager.reset_internal_state screenlog")
    ...
    def get_random_action(self) -> Dict[str, ActionType]:
        ...
        """
        screen.log_title("Andrew Sanity test MultiAgentLevelManager.get_random_action screenlog")
    ...
    def get_random_action_with_info(self) -> Dict[str, ActionInfo]:
        ...
        """
        screen.log_title("Andrew Sanity test MultiAgentLevelManager.get_random_action_with_info screenlog")
    ...
    def build(self, spaces_definition: SpacesDefinition = None) -> None:
        ...
        :return: None
        """
        screen.log_title("Andrew Sanity test MultiAgentLevelManager.build screenlog")
    ...
    def train(self) -> None:
        ...
        :return: the loss?
        """
        screen.log_title(f"Andrew Sanity test MultiAgentLevelManager.train screenlog with {len(self.agents.values())} agents")
    ...
    def acting_agent(self) -> AgentInterface:
        ...
        :return: Agent
        """
        screen.log_title("Andrew Sanity test MultiAgentLevelManager.acting_agent screenlog")
    ...
    def step(self, action: Union[None, Dict[str, ActionType]]) -> bool:
        ...
        :return: None
        """
        screen.log_title(f"======= Andrew Sanity test MultiAgentLevelManager.step screenlog with action {action} =======")
        ...
        for i in range(self.steps_limit.num_steps):
            ...
            if done:
                ...
                if any(action_infos):
                    screen.log_title(f"Andrew Sanity test MultiAgentLevelManager.step action_info.action {[action_info.__dict__ for action_info in action_infos]} screenlog")

                    # step environment
                    actions = [action_info.action if action_info else None
                                                           for action_info in action_infos]
                    screen.log_title(f"Andrew Sanity test MultiAgentLevelManager.step actions {actions} screenlog")

                    env_responses = self.environment.step(actions)
                    
                    screen.log_title(f"Andrew Sanity test MultiAgentLevelManager.step env_responses screenlog {env_responses}")
