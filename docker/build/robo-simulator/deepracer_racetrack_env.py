...
class DeepRacerRacetrackEnv(MultiAgentEnvironment):
    ...
    def __init__(self, level: LevelSelection, seed: int, frame_skip: int,
        ...
        try:
            ...
            print("DeepRacerRacetrackEnv: agent_list: ", self.agent_list)
            ...
            print("DeepRacerRacetrackEnv: action_space: ", self.action_space)
            print("DeepRacerRacetrackEnv: state_space: ", self.state_space)
            # Agents' info map
    ...
    def _take_action(self, action_list):
        try:
            ...
            print("DeepRacerRacetrackEnv: _take_action: action_list: ", action_list)
    ...
    def _update_state(self):
        try:
            ...
            for agent, action in zip(self.agent_list, self.action_list):
                print("DeepRacerRacetrackEnv: _update_state: agent: ", agent)
                print("DeepRacerRacetrackEnv: _update_state: agent.__dict__: ", agent.__dict__)

                print("DeepRacerRacetrackEnv: _update_state: action: ", action)
                print("DeepRacerRacetrackEnv: _update_state: self._agents_info_map: ", self._agents_info_map)
