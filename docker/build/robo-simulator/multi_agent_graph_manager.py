...
class MultiAgentGraphManager(object):
    ...
    def __init__(self, agents_params: List[AgentParameters], env_params: EnvironmentParameters,
        ...
        screen.log_title("Andrew Sanity test MultiAgentGraphManager.__init__ screenlog")
        ...
        screen.log_title(f"{str(self.agents_params)}")
        ...
        screen.log_title("Andrew Sanity test MultiAgentGraphManager init")

    def create_graph(self, task_parameters=TaskParameters(),
                     stop_physics=None, start_physics=None, empty_service_call=None):
        
        screen.log_title("Andrew Sanity test MultiAgentGraphManager.create_graph")
    ...
    def _create_graph(self, task_parameters: TaskParameters) -> Tuple[List[MultiAgentLevelManager], List[Environment]]:
        screen.log_title("Andrew Sanity test MultiAgentGraphManager._create_graph screenlog")
    ...
    def _create_worker_or_parameters_server_tf(task_parameters: DistributedTaskParameters):
        screen.log_title("Andrew Sanity test MultiAgentGraphManager._create_worker_or_parameters_server_tf screenlog")
    ...
    def _create_session_tf(self, task_parameters: TaskParameters):
        ...
        if isinstance(task_parameters, DistributedTaskParameters):
            ...
            # regular session
            screen.log_title("Creating regular session")
    ...
    def handle_episode_ended(self) -> None:
        ...
        :return: None
        """
        screen.log_title("Andrew Sanity test MultiAgentGraphManager.handle_episode_ended screenlog")
    ...
    def train(self) -> None:
        ...
        :return: None
        """
        screen.log_title("Andrew Sanity test MultiAgentGraphManager.train screenlog")
    ...
    def reset_internal_state(self, force_environment_reset=False) -> None:
        ...
        screen.log_title("Andrew Sanity test MultiAgentGraphManager.reset_internal_state screenlog")
    ...
    def act(self, steps: PlayingStepsType, wait_for_full_episodes=False) -> None:
        ...
        :param steps: the number of steps as a tuple of steps time and steps count
        """
        screen.log_title("Andrew Sanity test MultiAgentGraphManager.act screenlog")
        ...
        while self.current_step_counter < count_end or (wait_for_full_episodes and not done):
            ...
            screen.log_title("Andrew Sanity test MultiAgentGraphManager.act NONE screenlog")
